// Imports
import { PHYSICS } from './config.js?v=9';
import { levelTemplates as desktopLevels, calculateMaxScore } from './levels.js?v=9';
import { levelTemplates as mobileLevels } from './levels-mobile.js?v=9';
